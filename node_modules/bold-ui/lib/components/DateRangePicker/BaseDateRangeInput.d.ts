...
export declare function BaseDateRangeInput(props: BaseDateRangeInputProps): JSX.Element;
export declare namespace BaseDateRangeInput {
    var defaultProps: Partial<BaseDateRangeInputProps>;
}
